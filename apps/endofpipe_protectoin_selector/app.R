                      ...
                      sidebarLayout(
                        sidebarPanel(
                          selectInput("EoP_Proportion",
                                      ...
                                      selected = "97.5%"),
                          selectInput("EoP_Selecter", 
                                      label = "Select fish by:",
                                      choices = list("Group" = 0, "Common name" = 1, "Scientific name" = 2), 
                                      selected=0),
                        ...
                        mainPanel(
                          ...
                          h4("This tool calculates the screen area required to prevent impingement of fish."),
...
server <- function(input, output, session){ 
  ...
  #Select k and b based on Proportion of Fish Protected
  EoP_k <- reactive({
