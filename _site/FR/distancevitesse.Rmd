---
title: Outil de distance de nage et de vitesse de l’eau
output: 
  html_document:
    css: style.css
    theme: cosmo
...
<iframe id="nestedIFrame" src="http://www.fishprotectiontools.ca/fr/distancevitesse" width="100%" frameBorder="0" scrolling="no"></iframe>
