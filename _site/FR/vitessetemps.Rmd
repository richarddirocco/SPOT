---
title: Outil de vitesse et de temps de nage
output: 
  html_document:
    css: style.css
    theme: cosmo
...
<iframe id="nestedIFrame" src="http://www.fishprotectiontools.ca/fr/vitessetemps" width="100%" frameBorder="0" scrolling="no"></iframe>
