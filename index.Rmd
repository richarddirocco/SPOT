---
title: "Welcome to SPOT <br> Swim Performance Online Tools <hr>"
output: 
  html_document:
    css: style.css
    theme: cosmo
...
For more information on this tool and a sample problem, visit the [User Guide](http://www.fishprotectiontools.ca/userguide.html#speed_vs_time_example).
<center>
<figure>
...
For more information on this tool and a sample problem, visit the [User Guide](http://www.fishprotectiontools.ca/userguide.html#distance_vs_velocity_example).
